...
from Public.path import path_data_dir, path_data2_dir, path_msra_dir, path_renmin_dir,path_weibo_dir,path_onte_dir
import numpy as np
import os
...
class DataProcess(object):
    def __init__(self,
        ...
        if data_type == 'data':
            ...
            self.base_dir = path_weibo_dir
            # weibo_preprocessing()
        elif data_type == 'onte':
            self.base_dir = path_onte_dir
        else:
